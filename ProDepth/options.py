...
class MonodepthOptions:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="ProDepth options")
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark",
                                          "cityscapes_preprocessed","nuscenes"],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test",
                                          "cityscapes_preprocessed",'waymo','ddad','ns',"nuscenes"])
        ...
        self.parser.add_argument("--encoder",
                                 type=str,
                                 choices=['resnet', 'lite', 'lvt', 'convnext'],
                                 default='lite')

        self.parser.add_argument('--save',
                         action='store_true') 

        self.parser.add_argument("--mono_var_scale",
                                 type=int,
                                 default=20)
